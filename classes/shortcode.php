...
class Shortcode {
    ...
    static function _init(){
        \Config::load('shortcode',true);
        $codes = \Config::get('shortcode.codes');

        foreach($codes as $tag => $func){ 
            self::add($tag,$func); 
        }
    }
    ...
    public static function do_shortcode($content) {
        ...
        return preg_replace_callback('/' . $pattern . '/s', 'Shortcode::do_shortcode_tag', $content);
    }

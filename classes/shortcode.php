...
class Shortcode {
    ...
    function Shortcode($config = array()){
    ...
    function initialize($config=array()){
        ...
        foreach($config as $tag => $func){ echo $tag,' ',$func;
            $this->add($tag,$func);
        }
    }
    ...
    function do_shortcode($content) {
        ...
        return preg_replace_callback('/' . $pattern . '/s', 'ShortCode\Shortcode::do_shortcode_tag', $content);
    }
